...
const ASTUCES = [
  { id: 1, emoji: "🐕", titre: "Gerer l agressivite du chien en laisse", resume: "Strategies et Fleurs de Bach pour garder son sang-froid en balade.", tag: "Les bons gestes", url: "https://www.cec-saillysurlalys.com/post/agressivite-chien-laisse-fleurs-de-bach" },
  { id: 2, emoji: "🧦", titre: "Mon chien a mange une chaussette", resume: "Chiot ou adulte, votre chien peut avaler un vetement. Que faire ?", tag: "Premier secours", url: "https://www.cec-saillysurlalys.com/post/mon-chien-a-mang%C3%A9-une-chaussette" },
  { id: 3, emoji: "🧴", titre: "Mon chien a bu du detergent", resume: "La maison peut etre dangereuse. Que faire en cas d ingestion de produit menager ?", tag: "Premier secours", url: "https://www.cec-saillysurlalys.com/post/mon-chien-a-bu-du-d%C3%A9tergent" },
  { id: 4, emoji: "🕷", titre: "Les tiques", resume: "La tique est un acarien parasite. Comment la reconnaitre et la retirer ?", tag: "Premier secours", url: "https://www.cec-saillysurlalys.com/post/les-tiques" },
  { id: 5, emoji: "🐸", titre: "Mon chien a mange un crapaud", resume: "Nos compagnons sont tres curieux. Les bons reflexes si cela arrive.", tag: "Premier secours", url: "https://www.cec-saillysurlalys.com/post/mon-chien-a-mang%C3%A9-un-crapaud" },
  { id: 6, emoji: "🩹", titre: "Mon chien s est fait une plaie", resume: "Les chiens peuvent se blesser. En fonction de la gravite, voici comment reagir.", tag: "Premier secours", url: "https://www.cec-saillysurlalys.com/post/mon-chien-s-est-fait-une-plaie" },
  { id: 7, emoji: "🌊", titre: "Piqure de meduse", resume: "Vous emmenez votre chien a la mer ? Voici quoi faire en cas de contact.", tag: "Premier secours", url: "https://www.cec-saillysurlalys.com/post/piq%C3%BBre-de-m%C3%A9duse" },
  { id: 8, emoji: "🐾", titre: "Coupure du coussinet", resume: "En promenade ou a la maison, votre chien peut s ouvrir les coussinets.", tag: "Les bons gestes", url: "https://www.cec-saillysurlalys.com/post/coupure-du-coussinet" },
  { id: 9, emoji: "🐝", titre: "Piqure de guepe ou abeille", resume: "La curiosite de nos compagnons peut leur couter cher face a une guepe.", tag: "Premier secours", url: "https://www.cec-saillysurlalys.com/post/piq%C3%BBre-de-gu%C3%AApe-ou-abeille" },
  { id: 10, emoji: "🐶", titre: "Morsures entre congeneres", resume: "Les chiens ne peuvent pas toujours s entendre. Comment reagir ?", tag: "Premier secours", url: "https://www.cec-saillysurlalys.com/post/morsures-cong%C3%A9n%C3%A8res" },
  { id: 11, emoji: "🔥", titre: "Brulures", resume: "Barbecue, huile de friture ou sol trop chaud : comment soigner une brulure.", tag: "Premier secours", url: "https://www.cec-saillysurlalys.com/post/brulures" },
  { id: 12, emoji: "🐍", titre: "Morsure de serpent", resume: "En France, les viperes sont dangereuses pour nos chiens. Les bons reflexes.", tag: "Premier secours", url: "https://www.cec-saillysurlalys.com/post/mon-chien-s-est-fait-mordre-par-un-serpent" },
  { id: 13, emoji: "🚗", titre: "Mon chien a ete percute par une voiture", resume: "Si votre chien se fait renverser, voici la marche a suivre.", tag: "Premier secours", url: "https://www.cec-saillysurlalys.com/post/mon-chien-a-%C3%A9t%C3%A9-percut%C3%A9-par-une-voiture" },
  { id: 14, emoji: "🤕", titre: "Mon chien boite : entorse", resume: "Une entorse peut etre plus ou moins grave. Comment la reconnaitre ?", tag: "Les bons gestes", url: "https://www.cec-saillysurlalys.com/post/mon-chien-bo%C3%AEte-entorse" },
  { id: 15, emoji: "🚙", titre: "Mon chien est malade en voiture", resume: "Vomissements, salivation, prostration : les solutions pour les trajets.", tag: "Les bons gestes", url: "https://www.cec-saillysurlalys.com/post/mon-chien-est-malade-en-voiture" },
];
